...
public class DemoFeatureStepDef {
    ...
    @When("Something else is done again")
    public void something_else_is_done_again() {
        System.out.println("Something is done again");
    }

    @Then("Something else is expected again")
    public void something_else_is_expected_again() {
